...
public static class EventHandler
{
    ...
    {
        UpdateInventoryUI(location, list);
    }
    ...
    public static void CallGameMinuteEvent(int minute, int hour, int year, Season season)
    {
        GameMinuteEvent?.Invoke(minute, hour, year, season);
    }
    ...
    public static void CallParticleEffectEvent(ParticalEffectType effectType, Vector3 pos)
    {
